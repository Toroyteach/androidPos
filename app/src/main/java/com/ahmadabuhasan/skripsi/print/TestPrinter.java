...
public class TestPrinter implements IPrintToPrinter {
    ...
    public TestPrinter(Context context1, String shopName1, String shopAddress1, String shopEmail1, String shopContact1,
                       ...
                       String tax1, String discount1, String currency1, List<OrderDetailsModel> orderDetailsList) {
...
//        databaseAccess.open();
        this.orderDetailsList = orderDetailsList; //databaseAccess.getOrderDetailsList(invoiceId1);
    }
    ...
    public void printContent(WoosimPrnMng prnMng) {
        ...
        prnMng.printStr("Order Time: " + this.orderDate, 1, WoosimCmd.ALIGN_CENTER);
