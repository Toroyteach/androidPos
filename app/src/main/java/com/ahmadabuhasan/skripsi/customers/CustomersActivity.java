...
public class CustomersActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.progressBar = findViewById(R.id.customersListProgressBar);
        ...
        apiRequestHandler.getCustomers(
                customers -> {
                    ...
                    if(customers != null) {
                        ...
                        this.imgNoProduct.setVisibility(View.GONE);
                        CustomerAdapter customerAdapter1 = new CustomerAdapter(this, customers);
                        this.customerAdapter = customerAdapter1;
                        this.recyclerView.setAdapter(customerAdapter1);
