...
/*
 * Created by Ahmad Abu Hasan on 08/10/2021
 */
...
public class CartAdapter extends RecyclerView.Adapter<CartAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        String product_name = this.cart_product.get(position).get(DatabaseOpenHelper.PRODUCT_NAME);
...
//        textView1.setText(weight + " " + weight_unit_name);
        ...
        String imageUrl = this.cart_product.get(position).get(DatabaseOpenHelper.CART_PRODUCT_IMG);
