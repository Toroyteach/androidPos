...
public class DatabaseAccess {
    ...
    public int addToCart(String product_id, String name, String price, String unitprice, String imge, int qty, String stock) {
        SQLiteDatabase sqLiteDatabase = this.database;
        ...
        values.put(DatabaseOpenHelper.CART_PRODUCT_NAME, name);
        values.put(DatabaseOpenHelper.CART_PRODUCT_WEIGHT, 12);
        values.put(DatabaseOpenHelper.CART_PRODUCT_WEIGHT_UNIT, 1);
        values.put(DatabaseOpenHelper.CART_PRODUCT_PRICE, price);
        values.put(DatabaseOpenHelper.CART_PRODUCT_UNIT_PRICE, unitprice);
        values.put(DatabaseOpenHelper.CART_PRODUCT_IMG, imge);
...
//        return total_price;
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                int qty = cursor.getInt(cursor.getColumnIndex("product_qty"));
    ...
    public void clearProductCart() {
        ...
        db.delete(DatabaseOpenHelper.TABLE_PRODUCT_CART, null, null);
        db.close();
    }
    ...
    public ArrayList<HashMap<String, String>> getCartProduct() {
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                map.put(DatabaseOpenHelper.CART_PRODUCT_NAME, cursor.getString(2));
                map.put(DatabaseOpenHelper.CART_PRODUCT_WEIGHT, cursor.getString(3));
                map.put(DatabaseOpenHelper.CART_PRODUCT_WEIGHT_UNIT, cursor.getString(4));
                map.put(DatabaseOpenHelper.CART_PRODUCT_PRICE, cursor.getString(5));
                map.put(DatabaseOpenHelper.CART_PRODUCT_UNIT_PRICE, cursor.getString(6));
                map.put(DatabaseOpenHelper.CART_PRODUCT_IMG, cursor.getString(7));
                map.put(DatabaseOpenHelper.CART_PRODUCT_QTY, cursor.getString(8));
                map.put(DatabaseOpenHelper.CART_PRODUCT_STOCK, cursor.getString(9));
                product.add(map);
            } while (cursor.moveToNext());
        }
        cursor.close();
