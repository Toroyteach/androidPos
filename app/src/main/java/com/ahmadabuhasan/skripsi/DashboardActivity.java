...
public class DashboardActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageView_Profile = findViewById(R.id.profiledasboard);
        ...
        this.dashboardtext = findViewById(R.id.dashboard);
        ...
        final String userPhoto = user.getPhotoUrl();
        final String userName = user.getUsername();
        final String tenanturl = user.getTenantUrl();

        dashboardtext.setText(tenanturl);
        Picasso.get().load(userPhoto).into(imageView_Profile);
        ...
        this.imageView_Profile.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                i.setData(Uri.parse("https://github.com/Toroyteach"));
                startActivity(i);
            }
        });

        tvUserType.setText(getResources().getString(R.string.welcome) +" "+userName);
    ...
    public void logout() {
        imgLogout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                SharedPrefManager.getInstance(getApplicationContext()).clearUser();
                finish();
            }
        });
    }
