...
public class PosProductAdapter extends RecyclerView.Adapter<PosProductAdapter.MyViewHolder> {
    ...
    private final List<ProductModel> productData;
    MediaPlayer player;

    public PosProductAdapter(Context context1, List<ProductModel> productData1) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        String name = this.productData.get(position).getProduct_name();
        ...
        final String product_stock = String.valueOf(this.productData.get(position).getProduct_quantity());
        final String product_price = String.valueOf(this.productData.get(position).getProduct_price());
        final String unitprice = String.valueOf(this.productData.get(position).getProduct_cost());
        final String imageurl = String.valueOf(this.productData.get(position).getMedia());
...
//        String weight_unit_name = databaseAccess.getWeightUnitName(weight_unit_id);
        ...
        if (getStock1 > 5) {
            ...
            holder.textView_Stock.setTextColor(2);
        }
...
//                PosProductAdapter.this.context.startActivity(intent);
        ...
        holder.button_AddToCart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                databaseAccess.open();
                int check = databaseAccess.addToCart(product_id, name, product_price, unitprice, imageurl,1, product_stock);
                databaseAccess.open();
