...
public class OrderDetailsAdapter extends RecyclerView.Adapter<OrderDetailsAdapter.MyViewHolder> {
    ...
    Context context;
    private List<OrderDetailsModel> orderData;

    public OrderDetailsAdapter(Context context1, List<OrderDetailsModel> orderData1) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        holder.textView_ProductName.setText(this.orderData.get(position).getName());
        TextView textView = holder.textView_Qty;
        textView.setText(this.context.getString(R.string.quantity) + " " + this.orderData.get(position).getQuantity());
