...
public class CustomerAdapter extends RecyclerView.Adapter<CustomerAdapter.MyViewHolder> {
    ...
    public CustomerAdapter(Context context1, List<CustomerModel> customerData1) {
    ...
    public void onBindViewHolder(final MyViewHolder holder, int position) {
        final String customer_id = String.valueOf(this.customerData.get(position).getId());
        final String hp = this.customerData.get(position).getCustomer_phone();

        holder.textView_CustomerName.setText(this.customerData.get(position).getCustomer_name());
        holder.textView_Address.setText(this.customerData.get(position).getAddress());
        holder.textView_Hp.setText(hp);
        holder.textView_Wa.setText(this.customerData.get(position).getCity());
...
//
//            i.putExtra(DatabaseOpenHelper.CUSTOMER_ID, CustomerAdapter.this.customerData.get(getAdapterPosition())).get(DatabaseOpenHelper.CUSTOMER_ID));
//            i.putExtra(DatabaseOpenHelper.CUSTOMER_NAME, CustomerAdapter.this.customerData.get(getAdapterPosition())).get(DatabaseOpenHelper.CUSTOMER_NAME));
//            i.putExtra(DatabaseOpenHelper.CUSTOMER_ADDRESS, CustomerAdapter.this.customerData.get(getAdapterPosition())).get(DatabaseOpenHelper.CUSTOMER_ADDRESS));
//            i.putExtra(DatabaseOpenHelper.CUSTOMER_HP, CustomerAdapter.this.customerData.get(getAdapterPosition())).get(DatabaseOpenHelper.CUSTOMER_HP));
//            i.putExtra(DatabaseOpenHelper.CUSTOMER_WA, CustomerAdapter.this.customerData.get(getAdapterPosition())).get(DatabaseOpenHelper.CUSTOMER_WA));
//            i.putExtra(DatabaseOpenHelper.CUSTOMER_ACCOUNT, CustomerAdapter.this.customerData.get(getAdapterPosition())).get(DatabaseOpenHelper.CUSTOMER_ACCOUNT));
